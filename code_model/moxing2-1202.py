...
def a43_2(model, k, j, e, r):
    return  model.tekjer[k, j, e, r] <= x2 + LargeNumber * model.y3kjer[k, j, e, r]
...
def a43_5(model, k, j, e, r):
    return   - LargeNumber * (model.y3kjer[k, j, e, r] - model.xkjer[k, j, e, r]) <= model.Stekjer[k, j, e, r] - ((model.tekjer[k, j, e, r] - x1)/ (x2 - x1)) 
model.a43_5 = Constraint(model.K, model.J, model.E, model.R, rule=a43_5)

def a43_6(model, k, j, e, r):
    return   model.Stekjer[k, j, e, r] - ((model.tekjer[k, j, e, r] - x1)/ (x2 - x1))  <= LargeNumber * (model.y3kjer[k, j, e, r] - model.xkjer[k, j, e, r])
model.a43_6 = Constraint(model.K, model.J, model.E, model.R, rule=a43_6)


def a43_7(model, k, j, e, r):
    return   x2 - LargeNumber * model.y6kjer[k, j, e, r] <= model.tekjer[k, j, e, r]
model.a43_7 = Constraint(model.K, model.J, model.E, model.R, rule=a43_7)

def a43_8(model, k, j, e, r):
    return  model.tekjer[k, j, e, r] <= x3 + LargeNumber * model.y6kjer[k, j, e, r]
model.a43_8 = Constraint(model.K, model.J, model.E, model.R, rule=a43_8)
def a43_32(model, k, j, e, r):
    return - model.xkjer[k, j, e, r] * LargeNumber <= model.Stekjer[k, j, e, r]  
model.a43_32 = Constraint(model.K, model.J, model.E, model.R, rule=a43_32)

def a43_42(model, k, j, e, r):
    return model.Stekjer[k, j, e, r] <= model.xkjer[k, j, e, r] * LargeNumber
model.a43_42 = Constraint(model.K, model.J, model.E, model.R, rule=a43_42) 
def a43_9(model, k, j, e, r):
    return   - LargeNumber * (model.y6kjer[k, j, e, r] - model.xkjer[k, j, e, r])<= model.Stekjer[k, j, e, r] - 1 
model.a43_9 = Constraint(model.K, model.J, model.E, model.R, rule=a43_9)

def a43_10(model, k, j, e, r):
    return   model.Stekjer[k, j, e, r] - 1  <= LargeNumber * (model.y6kjer[k, j, e, r] - model.xkjer[k, j, e, r])
model.a43_10 = Constraint(model.K, model.J, model.E, model.R, rule=a43_10)



def a43_11(model, k, j, e, r):
    return   x3 - LargeNumber * (1-model.y7kjer[k, j, e, r]) <= model.tekjer[k, j, e, r]
model.a43_11 = Constraint(model.K, model.J, model.E, model.R, rule=a43_11)

def a43_12(model, k, j, e, r):
    return  model.tekjer[k, j, e, r] <= x4 + LargeNumber *  (1-model.y7kjer[k, j, e, r])
model.a43_12 = Constraint(model.K, model.J, model.E, model.R, rule=a43_12)

def a43_33(model, k, j, e, r):
    return - model.xkjer[k, j, e, r] * LargeNumber <= model.Stekjer[k, j, e, r]  
model.a43_33 = Constraint(model.K, model.J, model.E, model.R, rule=a43_33)

def a43_43(model, k, j, e, r):
    return model.Stekjer[k, j, e, r] <= model.xkjer[k, j, e, r] * LargeNumber
model.a43_43 = Constraint(model.K, model.J, model.E, model.R, rule=a43_43) 
def a43_15(model, k, j, e, r):
    return   - LargeNumber * (2-model.y7kjer[k, j, e, r] - model.xkjer[k, j, e, r]) <= model.Stekjer[k, j, e, r] - (( x4 - model.tekjer[k, j, e, r])/ (x4 - x3)) 
model.a43_15 = Constraint(model.K, model.J, model.E, model.R, rule=a43_15)

def a43_16(model, k, j, e, r):
    return   model.Stekjer[k, j, e, r] - (( x4 - model.tekjer[k, j, e, r])/ (x4 - x3)) <= LargeNumber * (2-model.y7kjer[k, j, e, r] - model.xkjer[k, j, e, r])
model.a43_16 = Constraint(model.K, model.J, model.E, model.R, rule=a43_16)
